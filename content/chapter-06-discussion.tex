...
The deployment of an AI tool like the assistant developed for this raises several ethical concerns, primarily regarding privacy and the trust feel for AI tools. Some answers in the survey forms provided in this course show that many students hold great concerns about AI tools and assistants, and their role within their educational environment.


An important concern that was raised in responses from students was the potential monitoring of the questions and interactions with the chatbot by the teachers. As was raised by one student in the forms, they explicitly stated \textit{"[the chat] is monitored by the teacher"} as the reason they hadn’t used the chatbot. Even though the assistant did offer a way for teachers to view the anonymous chats students had with the assistant, students weren’t told this fact. It’s noteworthy that a student simply presumed this to be true.
