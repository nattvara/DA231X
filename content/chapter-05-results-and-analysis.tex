...
Looking at other courses in figure~\ref{fig:usage_02_cumulative_number_of_chats_per_course} we can see that not all courses follow the same pattern as \textit{MG2040}. Some courses initially have very few chats. This is because the chatbot wasn’t deployed to all courses at the same time. \autoref{tab:course_start_dates} shows the start date for each course. Some courses, such as \textit{DD1349 Projektuppgift i introduktion till datalogi 3,0 hp} show a very steep increase in users when it was launched, and then stops increasing. The reason for this in this course was that the course officially ended just a few days after it was introduced. With all the courses that participated in the study, the bot was introduced into the course long after the course had started.
