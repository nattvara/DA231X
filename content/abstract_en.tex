...
%Background/Context: Briefly explain the research topic and why it is important.
%Objective: State the main aim or research question of the thesis.
%Methods: Summarize the methodology or approach used in the research.
%Results: Highlight the key findings or results.
%Conclusion: Present the main conclusions or implications of the research.
